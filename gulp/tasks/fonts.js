...
const otfToTtf = () => {
  return (
    app.gulp // Ищем файлы шрифтов .otf
...
const ttfToWoff = () => {
  return (
    app.gulp // Ищем файлы шрифтов .ttf
      ...
      // выгружаем в папку с результатом
      .pipe(app.gulp.dest(`${app.path.build.fonts}`))
    // Если раскомментировать, то возникает ошибко асинхронного кода
...
const unloadingWoff = () => {
  return (
    app.gulp //Ищем файлы шрифтов .woff и woff2
...
export { otfToTtf, ttfToWoff, unloadingWoff, fontStyle };
